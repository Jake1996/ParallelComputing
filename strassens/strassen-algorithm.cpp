...
void read(string filename, vector< vector<int> > &A, vector< vector<int> > &B,int n);
...
void strassenR(vector< vector<int> > &A, 
    ...
    // other cases are treated here:
        ...
        #pragma omp parallel sections private(aResult,bResult)
        {
            #pragma omp section 
            {
                aResult.resize(newTam,inner);
                bResult.resize(newTam,inner);
